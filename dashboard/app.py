...
if view_option == "📊 Overview":
    ...
    features = [
        ("📊 Return Rate", "#667eea"),
        ("💰 Price Anomaly", "#764ba2"),
        ("🔍 Suspicious Reason", "#ff6b6b"),
        ("⏰ Near Deadline", "#feca57"),
        ("🕸️ Fraud Rings", "#00d2d3")
    ]
    for col, (feature, color) in zip(cols, features):
        with col:
            st.markdown(f"""
                <div class="feature-tag" style="background:{color}20; color:{color};">
                    {feature}
                </div>
            """, unsafe_allow_html=True)
...
# ============================================================================
    ...
    with col1:
        num_returns = st.number_input(
            ...
            max_value=20,
            value=5,
            help="Generate predictions for multiple returns at once"
        )
    ...
    with col3:
        st.markdown("#### 🚀 Action")
        generate = st.button("🔄 Generate Batch Predictions", use_container_width=True)
        ...
        with st.spinner("🔮 Generating predictions..."):
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        results.append({
                            ...
                            'Confidence': f"{max(result['risk_score'], 1-result['risk_score'])*100:.1f}%"
                        })
                except:
                    pass
            ...
            if results:
                ...
                st.dataframe(
                    ...
                    hide_index=True,
                    column_config={
                        "Return ID": st.column_config.TextColumn("Return ID"),
                ...
                with col2:
                    ...
                    st.metric("Fraud Detected", fraud_count, delta=f"{fraud_count/len(results)*100:.1f}%")
                with col3:
...
# ============================================================================
    ...
    with col2:
        ...
        st.markdown("---")
        predict_btn = st.button("🔮 Analyze Fraud Risk", type="primary", use_container_width=True)
